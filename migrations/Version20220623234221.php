 ...
 */
final class Version20220623234221 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu_complements (menu_id INT NOT NULL, complements_id INT NOT NULL, INDEX IDX_52BE81ECD1322E03 (complements_id), INDEX IDX_52BE81ECCCD7E912 (menu_id), PRIMARY KEY(menu_id, complements_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
